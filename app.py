...
def add_like(message_id):
    ...
    """Checks if the message is already liked, removes from liked if true"""
    if message in g.user.likes:
        return redirect(f'/users/remove_like/{message.id}')
...
def remove_like(message_id):
    """Removes a message from the current user's liked messages"""
